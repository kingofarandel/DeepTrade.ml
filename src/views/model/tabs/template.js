                ...
                <Table responsive size='sm' hover>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> - </td>
                            <td>
                                <img height={30} style={{ marginRight: 5, cursor: 'pointer' }} src='/images/models/icons/edit_square.png' alt="delete_square" />
                                <img height={30} style={{ marginRight: 5, cursor: 'pointer' }} src='/images/models/icons/copy_square.png' alt="delete_square" />
                                <img height={30} style={{ marginRight: 5, cursor: 'pointer' }} src='/images/models/icons/delete_square.png' alt="delete_square" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img height={30} style={{ marginRight: 5, cursor: 'pointer' }} src='/images/models/icons/copy_square.png' alt="copy_square" />
                                <img height={30} style={{ marginRight: 5, cursor: 'pointer' }} src='/images/models/icons/delete_square.png' alt="delete_square" />
                                <img onClick={() => handleCollpase('tab3')} height={30} style={{ marginRight: 5, cursor: 'pointer' }} src='/images/models/icons/collapse.png' alt="square" />
                                <MoveItemButton />
                            </td>
                        </tr>
                        <tr>
